...
class Linear():
    def __init__(self, popt, parameter_errors, units_for_parameters):
        ...
        self.parameter_info = '\nm = (' + Output.print_with_uncertainty(self.m, self.m_error) + ') ' + \
                              self.units_for_parameters[0] + \
                              '\nc = (' + Output.print_with_uncertainty(self.c, self.c_error) + ') ' + \
                              self.units_for_parameters[1]
