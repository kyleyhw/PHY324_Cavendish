...
CW_1_angle_best_guess, CW_1_angle_uncertainty = CW_1_best_guess / l_best_guess, ErrorPropagation.root_sum_of_squares(np.array([CW_1_uncertainty, l_uncertainty]))
CCW_1_angle_best_guess, CCW_1_angle_uncertainty = CCW_1_best_guess / l_best_guess, ErrorPropagation.root_sum_of_squares(np.array([CCW_1_uncertainty, l_uncertainty]))

CW_2_angle_best_guess, CW_2_angle_uncertainty = CW_2_best_guess / l_best_guess, ErrorPropagation.root_sum_of_squares(np.array([CW_2_uncertainty, l_uncertainty]))
CCW_2_angle_best_guess, CCW_2_angle_uncertainty = CCW_2_best_guess / l_best_guess, ErrorPropagation.root_sum_of_squares(np.array([CCW_2_uncertainty, l_uncertainty]))
...
CW_1_G_best_guess, CW_1_G_uncertainty = G_guess(CW_1_b_best_guess, d_best_guess, CW_1_S_best_guess, m_best_guess, CW_1_T_best_guess, l_best_guess),\
...
CCW_1_G_best_guess, CCW_1_G_uncertainty = G_guess(CCW_1_b_best_guess, d_best_guess, CCW_1_S_best_guess, m_best_guess, CCW_1_T_best_guess, l_best_guess),\
...
CW_2_G_best_guess, CW_2_G_uncertainty = G_guess(CW_2_b_best_guess, d_best_guess, CW_2_S_best_guess, m_best_guess, CW_2_T_best_guess, l_best_guess),\
...
CCW_2_G_best_guess, CCW_2_G_uncertainty = G_guess(CCW_2_b_best_guess, d_best_guess, CCW_2_S_best_guess, m_best_guess, CCW_2_T_best_guess, l_best_guess),\
